...
/**
 * Hooks for CommissionLedger routes
 */
export interface CommissionLedgerHooks {
  /**
...
/**
 * Default CommissionLedger hooks (customize as needed)
 */
export const commissionLedgerHooks: CommissionLedgerHooks = {
