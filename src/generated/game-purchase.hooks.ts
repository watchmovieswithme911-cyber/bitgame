...
/**
 * Hooks for GamePurchase routes
 */
export interface GamePurchaseHooks {
  /**
...
/**
 * Default GamePurchase hooks (customize as needed)
 */
export const gamePurchaseHooks: GamePurchaseHooks = {
